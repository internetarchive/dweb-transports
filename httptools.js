 ...
 */
httptools.p_httpfetch = async function(httpurl, init, {wantstream=false, retries=undefined, silentFinalError=false}={}) { // Embrace and extend "fetch" to check result etc.
    try {
