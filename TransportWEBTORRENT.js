...
class TransportWEBTORRENT extends Transport {
    ...
    webtorrentparseurl(url) {
        /* Parse a URL
        url:    URL as string or already parsed into Url - should start magnet: or /magnet/ some other formats might be supported
        ...
        console.log("XXX@107 check this doesnt start with / then delete this comment" )
        url.replace('magnet/','magnet:');
